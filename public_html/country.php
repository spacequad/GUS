...
// +--------------------------------------------------------------------------+
// | country.php                                                              |
// | Displays country specific statistics                                     |
// +--------------------------------------------------------------------------+
// | $Id::                                                                   $|
// +--------------------------------------------------------------------------+
...
if ((file_exists(GUS_cachefile())) && ($today != $month . $year)) {
    ...
    $T->set_var('data',$LANG_GUS00['unique_visitors']);
    $T->parse('CBlock','COLUMN',false);
    $T->set_var( 'colclass', 'col_left' );

    $T->set_var('data',$LANG_GUS00['code']);
    ...
    {
        if ( is_numeric( $row['country']) || $row['country'] == '' )
        {
        ...
        else
        {
            ...
            if ( !isset( $country_list["$country"] ) )
    	        ...
    	        $country_list["$country"] = $country_list["$country"] + 1;
        }
    }
