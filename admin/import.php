...
$display .= GUS_step( 1, "Import ignored lists", "import_ignored" );
$display .= GUS_step( 2, "Add data to the user agents table", "import_user_agents" );
$display .= GUS_step( 3, "Import data from the userstats table", "import_userstats" );
$display .= GUS_step( 4, "Update data to latest version of GUS", "import_update" );
